                ...
                try {
                    ...
                    do {
                        ...
                        response.data.items.forEach(v=>{
                            v.medalName = v.medal_name;
                        });
                        medal_list = medal_list.concat(response.data.items);
                        curPage = response.data.page_info.cur_page;
        ...
        const Init = () => {
            try {
                ...
                Essential.init().then(() => {
                    ...
                    console.log("原作者的魔改脚本地址：https://github.com/pjy612/Bilibili-LRHH")
                    ...
                    uniqueCheck().then(() => {
                        ...
                        window.toast('魔改版本 2.4.6.9 (自动送礼fix)', 'info');
                        const InitData = () => {
                            const p = $.Deferred();
