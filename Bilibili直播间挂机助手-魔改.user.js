...
// @updateURL    https://raw.fastgit.org/3242394814/Bilibili-LRHH/main/Bilibili%E7%9B%B4%E6%92%AD%E9%97%B4%E6%8C%82%E6%9C%BA%E5%8A%A9%E6%89%8B-%E9%AD%94%E6%94%B9.user.js
// @downloadURL  https://raw.fastgit.org/3242394814/Bilibili-LRHH/main/Bilibili%E7%9B%B4%E6%92%AD%E9%97%B4%E6%8C%82%E6%9C%BA%E5%8A%A9%E6%89%8B-%E9%AD%94%E6%94%B9.user.js
...
(function BLRHH_Plus() {
    ...
    const DEBUGMODE = true || window.top.localStorage.getItem('BLRHH-DEBUG');
        ...
        const Essential = {
            ...
            Config: {
                ...
                HELP: {
                    ...
                    AUTO_GIFT_CONFIG: {
                        ROOMID: '填多个直播间号时顺序从左往右<br>数组,优先送礼物的直播间ID(即地址中live.bilibili.com/后面的数字), 设置为0则无优先房间，小于0也视为0（因为你没有0的勋章）<br>例如：17171,21438956<br>不管[优先高等级]如何设置，会根据[送满全部勋章]（补满或者只消耗当日到期）条件去优先送17171的，再送21438956<br>之后根据[优先高等级]决定送高级还是低级',
                        ...
                        SEND_ALL: '说明仅供参考：<br>打钩 礼物全部送满 不管到期时间，直到勋章亲密度满为止。<br>不打勾 送出包裹中到期时间（默认86400[1天]，可以自己设置）内的 所有类型（不包括永久） 礼物（若亲密度已满则不送）<br><br>原说明：打钩 送满全部勋章，否则 送出包裹中今天到期的礼物(会送出"默认礼物类型"之外的礼物，若今日亲密度已满则不送)',
                    ...
                    SHOW_TOAST: '选择是否显示浮动提示，但提示信息依旧会在控制台显示<mul style = "line-height:1em;"><div class="link-toast info fixed"><span class="toast-text">普通消息</span></div><br><br><br><div class="link-toast success fixed"><span class="toast-text">成功</span></div><br><br><br><div class="link-toast error fixed"><span class="toast-text">发生错误</span></div></mul>`'
                },
                showed: false,
                init: () => {
                    try {
...
.${NAME}_input_text {margin: -2px 0 -2px 4px;padding: 0;}`
        ...
        const Lottery = {
            ...
            MaterialObject: {
                list: [],
                ignore_keyword: ['test', 'encrypt', '测试', '钓鱼', '加密', '炸鱼', '脸'],//忽略列表，按格式写
                run: () => {
                    try {
